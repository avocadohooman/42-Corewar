...
/*   Updated: 2021/03/16 19:49:40 by gmolin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						form_statement(t_carriage *carry,
						unsigned char *arena);
int						get_args(t_carriage *carry,
						unsigned char *arena, int pos);
...
unsigned char			*fetch_position(unsigned char *ar,
						int pos, int where, int mod);
int						real_modulo(int position, int value, int modulo);

int						get_arg_value(t_carriage *carriage,
						int i, unsigned char *arena);
int						apply_offset(t_carriage *carriage, int arg_idx_value);
void					write_bytes(unsigned char *arena,
						int where, int what, int size);
